...
// Get the course code from the URL parameter
...
// If course details are found, display them
if ($course_details) {
  $title = $course_details['title'];
  $learningOutcomes = $course_details['learningOutcomes'];
  $topics = $course_details['topics'];
  $learningMaterials = $course_details['learningMaterials'];
  $assessmentsTasks = $course_details['assessmentsTasks'];
} else {
...
<body>
  <div class="p-4 sm:ml-64 sm:mr-[21rem]">
    <div class="pt-4 pl-4 rounded-2xl border-purple-blue mt-14">
      <h1 class="font-bold text-4xl pb-6 text-corn-flower-blue"><?php echo htmlspecialchars($title); ?></h1>
      <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-purple-100 text-indigo-600">
        ...
        <div id="accordion-color-body-2" class="hidden" aria-labelledby="accordion-color-heading-2">
          <div class="p-5 border border-b-0 border-purple-blue">
            <span class="mb-2 text-deep-koamaru">Learning Outcomes: <?php echo htmlspecialchars($learningOutcomes); ?></span>
            <div class="grid lg:grid-cols-3 sm:grid-cols-1 gap-4 mt-4">
              ...
              <div class="col-span-1">
                ...
                <ul class="list-none pt-4 text-deep-koamaru space-y-3">
                  <?php foreach ($learningMaterials as $material) { ?>
                    <li>
                      <a href="<?php echo htmlspecialchars($material['link']); ?>" class="w-full px-3 py-2 text-sm font-medium text-center inline-flex items-center text-royal-blue border border-royal-blue hover:bg-hawkes-blue focus:ring-4 focus:outline-none focus:ring-tropical-blue rounded-lg bg-solitude transition ease-in-out duration-300">
              ...
              <div class="col-span-1">
                ...
                <ul class="list-none pt-4 text-gray-500 dark:text-gray-400 space-y-3">
                  <?php foreach ($assessmentsTasks as $task) { ?>
                    <li>
                      <a href="<?php echo htmlspecialchars($task['link']); ?>" class="w-full px-3 py-2 text-sm font-medium text-center inline-flex items-center text-camarone border border-camarone hover:bg-granny-apple focus:ring-4 focus:outline-none focus:ring-chinook rounded-lg transition duration-300 ease-in-out bg-off-green">
