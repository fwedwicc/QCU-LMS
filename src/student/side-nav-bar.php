...
<body>
  ...
  <!-- Left Sidebar -->
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-all duration-300 -translate-x-full bg-lav-sant border-r border-lavender-blue sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-5 pb-5 overflow-y-auto bg-lav-sant flex flex-col justify-between">
      <!-- Top Side -->
      <ul class="space-y-1 font-medium text-base">
        ...
        <li>
          ...
          <a href="" class="flex items-center p-3 text-corn-flower-blue rounded-lg hover:bg-ghost-lavender group transition duration-300 ease-in-out hover:text-neon-blue">
            ...
            <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-neon-blue bg-ghost-lavender rounded-full">4</span>
          </a>
        </li>
      </ul>
      <!-- Bottom Side -->
      <ul class="space-y-1 font-medium">
        ...
        <li class="pt-4">
          <!-- Link -->
          <div class="border flex items-center p-4 gap-3 bg-ghost-lavender rounded-lg">
            <img class="w-9 h-auto rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo">
            <div>
              <span class=" text-sm block text-deep-koamaru font-bold">Juan Dela Cruz</span>
              <span class="truncate text-xs text-deep-koamaru font-thin">juan.dc.12@gmail.com</span>
            </div>
          </div>
        </li>
      </ul>
