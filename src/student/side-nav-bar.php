      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <a href="#" class="flex ms-3 md:me-24">
            ...
            <span class="logo-title">QCU-LMS</span>
          </a>
        </div>
        <div class="flex items-center">
          ...
          <!-- Notification Menu-->
          <div id="dropdownNotification" class="notif-container" aria-labelledby="dropdownNotificationButton">
            <div class="notif-header">
              Notifications
            </div>
            <!-- Notification Content -->
            <div id="notification-container" class="divide-y divide-indigo-100 dark:divide-slate-700">
              <!-- Rendered Data for notification -->
            </div>
            <!-- TODO: View all button / Announcement Modal -->
  ...
  <aside id="left-sidebar" class="sidebar" aria-label="Sidebar">
    <div class="sidebar-container">
      ...
      <ul class="space-y-1 font-medium text-base">
        ...
        <li>
          <!-- Subjects -->
          <!-- TODO: Subjects Popover -->
          <a href="./test-page.php" id="subject-btn" class="nav-btn group">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="nav-btn-icon group-hover:text-neon-blue" id="subject-icon">
      ...
      <ul class="space-y-1 font-medium border-lavender-blue dark:border-dark-lavender-blue border-t pt-4">
        <li>
          <!-- Notification -->
          <!-- TODO: Notification (Overall) Modal -->
        ...
        <li>
          <!-- Settings -->
          <!-- TODO: Settings Page -->
          <a href="./student-settings.php" class="nav-btn group" id="settings-btn">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="nav-btn-icon group-hover:text-neon-blue" id="settings-icon">
